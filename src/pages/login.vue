...
<div class="w-1/3 bg-gray-bg bg-cover bg-center flex flex-col justify-center items-center p-8">
    ...
    <div class="w-2/3 bg-[#1A1D29] flex flex-col justify-center items-center p-12">
      <h2 class="text-4xl text-white font-bold mb-12 pb-12">Application de gestion des projets de MMI Montbéliard</h2>
...
// Ici, tu pourrais gérer les soumissions de formulaire avec des fonctions asynchrones
</script>
